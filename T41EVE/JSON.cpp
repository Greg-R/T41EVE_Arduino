...
FLASHMEM void JSON::loadConfiguration(const char *filename, config_t &ConfigData) {
  ...
  ConfigData.ANR_notch = doc["ANR_notch"];
  ...
  ConfigData.spareInt = doc["spareInt"];
  ...
  ConfigData.ANR_notch = doc["ANR_notch"] | true;
...
FLASHMEM void JSON::saveConfiguration(const char *filename, const config_t &ConfigData, bool toFile) {
  ...
  doc["ANR_notch"] = ConfigData.ANR_notch;
  ...
  doc["spareInt"] = ConfigData.spareInt;
